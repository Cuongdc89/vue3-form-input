            ...
            <div class="form-group">
              ...
              <div class="form-item col">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="cuongdc316@gmail.com"
                  v-model="quiz.email"
                />
              </div>
            </div>
        ...
        <div class="col-4">
          <div class="section right">
            ...
            <div class="form-item">
              ...
              <textarea
                id="about"
                placeholder="Hey Team, I’d love  to talk to you about  branding this Something AI  project we’re working..."
                v-model="quiz.desc"
              />
            </div>
            <div class="form-item">
